//
// File: test02_cdmp_without_obstacle_1219.cpp
//
...
//
#include "test02_cdmp_without_obstacle_1219.h"
...
extern void test02_cdmp_without_obstacle_1219_derivatives(real_T *arg_m_Xp,
...
#define rtNSTAGES                      13
  ...
  for (stagesIdx=0;stagesIdx<rtNSTAGES;stagesIdx++) {
    ...
    if (stagesIdx==0) {
      ...
      test02_cdmp_without_obstacle_1219_derivatives(arg_m_Xp, arg_m_e, arg_X3,
        arg_X4);
    } else {
                     ...
                     arg_X4[3])
{
  ...
  // Sum: '<S1>/Sum'
  rtb_Sum_n = rtDW.m_X1[0] - rtDW.m_X2[0];

  // MATLAB Function: '<S1>/MATLAB Function4'
  absxk = std::abs(rtb_Sum_n);
  ...
  // Sum: '<S1>/Sum'
  rtb_Sum_n = rtDW.m_X1[1] - rtDW.m_X2[1];
  ...
  // Sum: '<S1>/Sum'
  rtb_Sum_n = rtDW.m_X1[2] - rtDW.m_X2[2];
  ...
  MATLABFunction14(rtX.Integrator2_CSTATE, rtb_Sum);
  ...
  rtDW.Gain27[0] = ((((1050.0 * rtb_Sum[0] + -194.421 * rtDW.m_X3dot[0]) + (g1[0]
  ...
  rtDW.Gain27[1] = ((((1050.0 * rtb_Sum[1] + -194.421 * rtDW.m_X3dot[1]) + (g1[1]
  ...
  rtDW.Gain27[2] = ((((1050.0 * rtb_Sum[2] + -194.421 * rtDW.m_X3dot[2]) + (g1[2]
  ...
  rtDW.Add[0] = ((((((rtP.k1 * rtDW.m_X3[0] + Add_tmp_0) + Add_tmp) + rtP.b1 *
                    rtDW.m_X3dot[0]) - rtP.k1 * rtDW.m_X1[0]) - rtb_Sum_n) -
  ...
  rtDW.Add1[0] = ((((((rtP.k3 * rtDW.m_X4[0] + rtb_Sum_n) + rtb_Add2) + rtP.b3 *
  ...
  rtDW.Add[1] = ((((((rtP.k1 * rtDW.m_X3[1] + Add_tmp_0) + Add_tmp) + rtP.b1 *
                    rtDW.m_X3dot[1]) - rtP.k1 * rtDW.m_X1[1]) - rtb_Sum_n) -
  ...
  rtDW.Add1[1] = ((((((rtP.k3 * rtDW.m_X4[1] + rtb_Sum_n) + rtb_Add2) + rtP.b3 *
  ...
  rtDW.Add[2] = ((((((rtP.k1 * rtDW.m_X3[2] + Add_tmp_0) + Add_tmp) + rtP.b1 *
                    rtDW.m_X3dot[2]) - rtP.k1 * rtDW.m_X1[2]) - rtb_Sum_n) -
  ...
  rtDW.Add1[2] = ((((((rtP.k3 * rtDW.m_X4[2] + rtb_Sum_n) + rtb_Add2) + rtP.b3 *
  ...
  MATLABFunction14(rtX.Integrator4_CSTATE, rtb_Sum);
  ...
  rtDW.Gain18[0] = ((((-194.421 * rtDW.m_X4dot[0] + rtb_Sum[0]) + (g2[0] -
  ...
  rtDW.Gain18[1] = ((((-194.421 * rtDW.m_X4dot[1] + rtb_Sum[1]) + (g2[1] -
  ...
  rtDW.Gain18[2] = ((((-194.421 * rtDW.m_X4dot[2] + rtb_Sum[2]) + (g2[2] -
  ...
  for (k = 0; k < 2; k++) {
    ...
    absxk = t / rtb_Sum_n;
    scale = absxk * absxk;
    rtb_Sum[0] = t / (rtb_Sum_n * rtb_Sum_n);
    rtb_Sum_n = axis[k + 2];
    t = rtDW.m_X4[1] - center[k + 2];
    absxk = t / rtb_Sum_n;
    scale += absxk * absxk;
    rtb_Sum[1] = t / (rtb_Sum_n * rtb_Sum_n);
    rtb_Sum_n = axis[k + 4];
    ...
    absxk = std::exp(-scale);
    scale = 1.0 / scale / scale + 1.0 / scale;
    rtDW.m_obs_weight_r[0] += rtb_Sum[0] * absxk * scale * 2.0;
    rtDW.m_obs_weight_r[1] += rtb_Sum[1] * absxk * scale * 2.0;
    rtDW.m_obs_weight_r[2] += t / (rtb_Sum_n * rtb_Sum_n) * absxk * scale * 2.0;
  }
...
void SignalDmp::test02_cdmp_without_obstacle_1219_derivatives(real_T *arg_m_Xp,
  real_T *arg_m_e, real_T arg_X3[3], real_T arg_X4[3])
{
