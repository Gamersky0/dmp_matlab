...
void Model_3DModelClass::step()
{
  ...
  Model_3D_B.Add[0] = Model_3D_P.k2 * Model_3D_X.x2_CSTATE[0];

  // Gain: '<S9>/Gain11' incorporates:
  //   Gain: '<S1>/Gain1'

  a = Model_3D_P.b2 * Model_3D_B.x2[0];

  // Gain: '<S9>/Gain15' incorporates:
  //   Gain: '<S1>/Gain4'
  //   Integrator: '<S1>/x1'

  axis = Model_3D_P.k2 * Model_3D_X.x1_CSTATE[0];

  // Gain: '<S9>/Gain9' incorporates:
  //   Gain: '<S1>/Gain6'

  a_tmp = Model_3D_P.b2 * Model_3D_B.x1[0];
  ...
  Model_3D_B.Add1[0] = ((((((Model_3D_P.k3 * Model_3D_X.right_CSTATE[0] + axis)
    + a_tmp) + Model_3D_P.b3 * Model_3D_B.x4[0]) - a) - Model_3D_B.Add[0]) -
                        Model_3D_P.k3 * Model_3D_X.x2_CSTATE[0]) - Model_3D_P.b3
    * Model_3D_B.x2[0];
  ...
  Model_3D_B.Add[0] = ((((((Model_3D_P.k1 * Model_3D_X.left_CSTATE[0] +
    Model_3D_B.Add[0]) + a) + Model_3D_P.b1 * Model_3D_B.x3[0]) - Model_3D_P.k1 *
    Model_3D_X.x1_CSTATE[0]) - axis) - Model_3D_P.b1 * Model_3D_B.x1[0]) - a_tmp;
  ...
  Model_3D_B.Add[1] = Model_3D_P.k2 * Model_3D_X.x2_CSTATE[1];

  // Gain: '<S9>/Gain11' incorporates:
  //   Gain: '<S1>/Gain1'

  a = Model_3D_P.b2 * Model_3D_B.x2[1];

  // Gain: '<S9>/Gain15' incorporates:
  //   Gain: '<S1>/Gain4'
  //   Integrator: '<S1>/x1'

  axis = Model_3D_P.k2 * Model_3D_X.x1_CSTATE[1];

  // Gain: '<S9>/Gain9' incorporates:
  //   Gain: '<S1>/Gain6'

  a_tmp = Model_3D_P.b2 * Model_3D_B.x1[1];
  ...
  Model_3D_B.Add1[1] = ((((((Model_3D_P.k3 * Model_3D_X.right_CSTATE[1] + axis)
    + a_tmp) + Model_3D_P.b3 * Model_3D_B.x4[1]) - a) - Model_3D_B.Add[1]) -
                        Model_3D_P.k3 * Model_3D_X.x2_CSTATE[1]) - Model_3D_P.b3
    * Model_3D_B.x2[1];
  ...
  Model_3D_B.Add[1] = ((((((Model_3D_P.k1 * Model_3D_X.left_CSTATE[1] +
    Model_3D_B.Add[1]) + a) + Model_3D_P.b1 * Model_3D_B.x3[1]) - Model_3D_P.k1 *
    Model_3D_X.x1_CSTATE[1]) - axis) - Model_3D_P.b1 * Model_3D_B.x1[1]) - a_tmp;
  ...
  Model_3D_B.Add[2] = Model_3D_P.k2 * Model_3D_X.x2_CSTATE[2];

  // Gain: '<S9>/Gain11' incorporates:
  //   Gain: '<S1>/Gain1'

  a = Model_3D_P.b2 * Model_3D_B.x2[2];

  // Gain: '<S9>/Gain15' incorporates:
  //   Gain: '<S1>/Gain4'
  //   Integrator: '<S1>/x1'

  axis = Model_3D_P.k2 * Model_3D_X.x1_CSTATE[2];

  // Gain: '<S9>/Gain9' incorporates:
  //   Gain: '<S1>/Gain6'

  a_tmp = Model_3D_P.b2 * Model_3D_B.x1[2];
  ...
  Model_3D_B.Add1[2] = ((((((Model_3D_P.k3 * Model_3D_X.right_CSTATE[2] + axis)
    + a_tmp) + Model_3D_P.b3 * Model_3D_B.x4[2]) - a) - Model_3D_B.Add[2]) -
                        Model_3D_P.k3 * Model_3D_X.x2_CSTATE[2]) - Model_3D_P.b3
    * Model_3D_B.x2[2];
  ...
  Model_3D_B.Add[2] = ((((((Model_3D_P.k1 * Model_3D_X.left_CSTATE[2] +
    Model_3D_B.Add[2]) + a) + Model_3D_P.b1 * Model_3D_B.x3[2]) - Model_3D_P.k1 *
    Model_3D_X.x1_CSTATE[2]) - axis) - Model_3D_P.b1 * Model_3D_B.x1[2]) - a_tmp;
