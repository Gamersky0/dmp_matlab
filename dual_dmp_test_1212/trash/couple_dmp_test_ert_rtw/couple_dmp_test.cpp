...
void SignalDmp::step()
{
  ...
  rtDW.Sum = rtb_y_o - (10.0 * rtX.referencemodel_CSTATE[1] +
                        rtX.referencemodel_CSTATE[0]);
  ...
  rtb_Gain_d = (-1.2 * rtX.gamma1s_CSTATE * rtDW.Sum * rtDW.Step - 0.5 *
                rtX.gamma2s_CSTATE * rtb_y_o * rtb_y_o) * -10000.0;

  // Gain: '<S1>/Gain20'
  rtb_y_o = -5.0 * rtb_Gain_d;
  ...
  for (iy = 0; iy < 2; iy++) {
    axis = axis_0[iy];
    rtb_gamma1s_tmp = rtX.right_CSTATE[0] - center[iy];
    rtb_gamma1s = rtb_gamma1s_tmp / axis;
    rtb_u_e = rtb_gamma1s * rtb_gamma1s;
    phi[0] = rtb_gamma1s_tmp / (axis * axis);
    axis = axis_0[iy + 2];
    rtb_gamma1s_tmp = rtX.right_CSTATE[1] - center[iy + 2];
    rtb_gamma1s = rtb_gamma1s_tmp / axis;
    rtb_u_e += rtb_gamma1s * rtb_gamma1s;
    phi[1] = rtb_gamma1s_tmp / (axis * axis);
    axis = axis_0[iy + 4];
    rtb_gamma1s_tmp = rtX.right_CSTATE[2] - center[iy + 4];
    rtb_gamma1s = rtb_gamma1s_tmp / axis;
    rtb_u_e += rtb_gamma1s * rtb_gamma1s;
    phi[2] = rtb_gamma1s_tmp / (axis * axis);
    rtb_u_e--;
    rtb_gamma1s = std::exp(-rtb_u_e);
    rtb_u_e = 1.0 / rtb_u_e / rtb_u_e + 1.0 / rtb_u_e;
    axis = phi[0] * rtb_gamma1s * rtb_u_e * 2.0;
    phi[0] = axis;
    rtb_OUT[0] += axis;
    axis = phi[1] * rtb_gamma1s * rtb_u_e * 2.0;
    phi[1] = axis;
    rtb_OUT[1] += axis;
    axis = phi[2] * rtb_gamma1s * rtb_u_e * 2.0;
    phi[2] = axis;
    rtb_OUT[2] += axis;
  }
  ...
  rtDW.Gain18[0] = (((((1050.0 * phi[0] + -194.421 * rtDW.x4[0]) + (-1.0 -
    rtX.right_CSTATE[0]) * 1050.0) + 1050.0 * rtX.Integrator4_CSTATE) + rtb_y_o)
                    + rtb_OUT[0]) * 0.1111111111111111;
  ...
  rtb_gamma1s = 1050.0 * rtX.x2_CSTATE[0];
  ...
  rtb_gamma1s_tmp = 64.8074 * rtDW.x1[0];
  ...
  rtDW.Add1[0] = ((((((1050.0 * rtX.right_CSTATE[0] + rtb_u_e) + rtb_gamma1s_tmp)
                     + 64.8074 * rtDW.x4[0]) - axis) - rtb_gamma1s) -
                  rtb_gamma1s) - axis;
  ...
  rtDW.Add[0] = ((((((1050.0 * rtX.left_CSTATE[0] + rtb_gamma1s) + axis) +
                    64.8074 * rtDW.x3[0]) - rtb_u_e) - rtb_u_e) -
                 rtb_gamma1s_tmp) - rtb_gamma1s_tmp;
  ...
  rtDW.Gain18[1] = (((((1050.0 * phi[1] + -194.421 * rtDW.x4[1]) + (0.6 -
    rtX.right_CSTATE[1]) * 1050.0) + -0.0 * rtX.Integrator4_CSTATE) + rtb_y_o) +
                    rtb_OUT[1]) * 0.1111111111111111;
  ...
  rtb_gamma1s = 1050.0 * rtX.x2_CSTATE[1];
  ...
  rtb_gamma1s_tmp = 64.8074 * rtDW.x1[1];
  ...
  rtDW.Add1[1] = ((((((1050.0 * rtX.right_CSTATE[1] + rtb_u_e) + rtb_gamma1s_tmp)
                     + 64.8074 * rtDW.x4[1]) - axis) - rtb_gamma1s) -
                  rtb_gamma1s) - axis;
  ...
  rtDW.Add[1] = ((((((1050.0 * rtX.left_CSTATE[1] + rtb_gamma1s) + axis) +
                    64.8074 * rtDW.x3[1]) - rtb_u_e) - rtb_u_e) -
                 rtb_gamma1s_tmp) - rtb_gamma1s_tmp;
  ...
  rtDW.Gain18[2] = (((((1050.0 * phi[2] + -194.421 * rtDW.x4[2]) + (1.0 -
    rtX.right_CSTATE[2]) * 1050.0) + -1050.0 * rtX.Integrator4_CSTATE) + rtb_y_o)
                    + rtb_OUT[2]) * 0.1111111111111111;
  ...
  rtb_gamma1s = 1050.0 * rtX.x2_CSTATE[2];
  ...
  rtb_gamma1s_tmp = 64.8074 * rtDW.x1[2];
  ...
  rtDW.Add1[2] = ((((((1050.0 * rtX.right_CSTATE[2] + rtb_u_e) + rtb_gamma1s_tmp)
                     + 64.8074 * rtDW.x4[2]) - axis) - rtb_gamma1s) -
                  rtb_gamma1s) - axis;
  ...
  rtDW.Add[2] = ((((((1050.0 * rtX.left_CSTATE[2] + rtb_gamma1s) + axis) +
                    64.8074 * rtDW.x3[2]) - rtb_u_e) - rtb_u_e) -
                 rtb_gamma1s_tmp) - rtb_gamma1s_tmp;
  ...
  rtb_gamma1s = (rtX.left_CSTATE[0] - 0.15) / 0.1;
  rtb_u_e = rtb_gamma1s * rtb_gamma1s;
  rtb_OUT[0] = (rtX.left_CSTATE[0] - 0.15) / 0.010000000000000002;
  rtb_gamma1s = (rtX.left_CSTATE[1] - 0.2) / 0.1;
  rtb_u_e += rtb_gamma1s * rtb_gamma1s;
  rtb_OUT[1] = (rtX.left_CSTATE[1] - 0.2) / 0.010000000000000002;
  rtb_gamma1s = (rtX.left_CSTATE[2] - 0.4) / 0.1;
  rtb_u_e += rtb_gamma1s * rtb_gamma1s;
  ...
  rtDW.Gain27[0] = (((((1050.0 * phi[0] + -194.421 * rtDW.x3[0]) + (-1.0 -
    rtX.left_CSTATE[0]) * 1050.0) + 1050.0 * rtX.Integrator2_CSTATE) +
                     rtb_Gain_d) + rtb_OUT[0] * rtb_gamma1s * rtb_u_e * 2.0) *
    0.1111111111111111;
  ...
  rtDW.Gain27[1] = (((((1050.0 * phi[1] + -194.421 * rtDW.x3[1]) + (0.0 -
    rtX.left_CSTATE[1]) * 1050.0) + -0.0 * rtX.Integrator2_CSTATE) + rtb_Gain_d)
                    + rtb_OUT[1] * rtb_gamma1s * rtb_u_e * 2.0) *
    0.1111111111111111;
  ...
  rtDW.Gain27[2] = (((((1050.0 * phi[2] + -194.421 * rtDW.x3[2]) + (1.0 -
    rtX.left_CSTATE[2]) * 1050.0) + -1050.0 * rtX.Integrator2_CSTATE) +
                     rtb_Gain_d) + rtb_OUT[2] * rtb_gamma1s * rtb_u_e * 2.0) *
    0.1111111111111111;
  ...
  MATLABFunction4(rtb_OUT, &rtb_Gain_d);
